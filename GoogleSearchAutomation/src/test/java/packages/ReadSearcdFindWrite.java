...
public class ReadSearcdFindWrite {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		String[] desiredSheetNames = {"Saturday", "Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday"};

		// Iterate through each desired sheet name
		for (String sheetName : desiredSheetNames) {
